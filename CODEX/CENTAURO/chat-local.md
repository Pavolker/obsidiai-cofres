...
Documentar o app local de chat com provedores locais e cloud, integrado ao Obsidian/RAG.
...
O README lista Ollama, LM Studio, provedores cloud, variaveis de ambiente e integracao com Obsidian, Vida e Livros.

## Arquivos relevantes

- `CHAT LOCAL/README.md`
- `CHAT LOCAL/CHAT_BRAIN.md`
- `CHAT LOCAL/docker-compose.yml`
- `CHAT LOCAL/init.sql`
- `CHAT LOCAL/INTEGRATION_GUIDE.md`

## Fatos

- suporta provedores locais e cloud
- expõe endpoints de sync, search, retrieve e chat
- usa um perfil operacional carregado em todo prompt

## Decisoes

- manter a camada RAG separada dos providers
- preservar a memoria de conversa e o historico por chat

## Prompts que funcionaram

- "Resuma o funcionamento do Chat Local e os pontos de integracao"
