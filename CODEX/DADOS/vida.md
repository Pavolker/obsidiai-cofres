...
Registrar o cofre/projeto VIDA como memoria de vida e material de apoio local.
...
A pasta guarda SQL, planilhas, documentos e o vault `VAULT_VIDA`, indicando um conjunto de memoria e dados pessoais.

## Arquivos relevantes

- `VIDA/01_CRIAR_BANCO.sql`
- `VIDA/SCHEMA_CENTAURO.sql`
- `VIDA/VIDA 2022.xlsx`
- `VIDA/VIDA.md`
- `VIDA/VAULT_VIDA/`
...
- nao existe README localizado
- o projeto parece reunir memoria, dados e banco local

## Decisoes

- tratar a pasta como base de memoria operacional pessoal
- manter documentos e planilhas como insumos do vault

## Prompts que funcionaram

- "Explique a estrutura da pasta Vida e seu papel como memoria"
