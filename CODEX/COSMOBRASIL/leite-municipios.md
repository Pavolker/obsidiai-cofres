...
Registrar a aplicacao estatica de municipios do leite com CSV, JS, HTML e CSS.

## Status

- atual: sem README localizado
- prioridade: a definir
- ultima atualizacao: 2026-04-09

## Contexto

A pasta contem planilhas CSV, `index.html`, `script.js` e `styles.css`, indicando uma interface web simples para consulta ou visualizacao.

## Arquivos relevantes

- `LEITE MUNICIPIOS/LEITE  - PB.csv`
- `LEITE MUNICIPIOS/LEITE - CE.csv`
- `LEITE MUNICIPIOS/data.js`
- `LEITE MUNICIPIOS/index.html`
- `LEITE MUNICIPIOS/script.js`
- `LEITE MUNICIPIOS/styles.css`

## Fatos

- nao existe README na pasta
- o projeto parece ser uma pagina estatico-dados

## Decisoes

- manter os CSVs como base de dados local
- usar HTML/CSS/JS para a camada de apresentacao

## Prompts que funcionaram

- "Resuma o projeto Leite Municipios com base nos arquivos da pasta"

## Session log

- 2026-04-09: nota atualizada com base na estrutura da pasta
